...
from .credits import FREE_MONTHLY_CREDITS, generation_cost, get_or_create_credit_account, grant_free_allowance, reserve_generation
...
class CreditServiceTests(TestCase):
    ...
    def test_new_user_gets_free_allowance_once(self):
        self.assertEqual(FREE_MONTHLY_CREDITS, 10)
        balance = grant_free_allowance(self.user)
        ...
        same = grant_free_allowance(self.user)
