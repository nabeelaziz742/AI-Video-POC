...
from .models import Character, CreditAccount, CreditTransaction, UsageEvent, VideoProject, VideoScene


@admin.register(VideoProject)
class VideoProjectAdmin(admin.ModelAdmin):
    list_display = ("title", "user", "version_number", "status", "duration", "aspect_ratio", "created_at", "updated_at")
