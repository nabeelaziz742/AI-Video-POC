...
class VideoProject(models.Model):
    ...
    user=models.ForeignKey(settings.AUTH_USER_MODEL,related_name="video_projects",on_delete=models.CASCADE,null=True,blank=True); version_group=models.UUIDField(default=uuid.uuid4,editable=False,db_index=True); version_number=models.PositiveIntegerField(default=1); title=models.CharField(max_length=255); input_type=models.CharField(max_length=20,choices=InputType.choices,default=InputType.STORY); prompt=models.TextField(); aspect_ratio=models.CharField(max_length=10,default="9:16"); duration=models.PositiveIntegerField(default=30); status=models.CharField(max_length=20,choices=Status.choices,default=Status.DRAFT); provider=models.CharField(max_length=50,default="json2video"); provider_project_id=models.CharField(max_length=100,blank=True,null=True); video_url=models.URLField(blank=True,null=True); error_message=models.TextField(blank=True,null=True); generation_attempt=models.PositiveIntegerField(default=0); processing_started_at=models.DateTimeField(blank=True,null=True); completed_at=models.DateTimeField(blank=True,null=True); failed_at=models.DateTimeField(blank=True,null=True); created_at=models.DateTimeField(auto_now_add=True); updated_at=models.DateTimeField(auto_now=True)
...
class VideoScene(models.Model):
    ...
    project=models.ForeignKey(VideoProject,related_name="scenes",on_delete=models.CASCADE); scene_number=models.PositiveIntegerField(); duration=models.PositiveIntegerField(); prompt=models.TextField(); characters=models.ManyToManyField(Character,related_name="scenes",blank=True); status=models.CharField(max_length=20,choices=Status.choices,default=Status.PLANNED); provider=models.CharField(max_length=50,default="pending"); provider_project_id=models.CharField(max_length=120,blank=True,null=True); video_url=models.URLField(blank=True,null=True); error_message=models.TextField(blank=True,null=True); generation_attempt=models.PositiveIntegerField(default=0); processing_started_at=models.DateTimeField(blank=True,null=True); completed_at=models.DateTimeField(blank=True,null=True); failed_at=models.DateTimeField(blank=True,null=True); created_at=models.DateTimeField(auto_now_add=True)
...
class Subscription(models.Model):
    ...
    user=models.OneToOneField(settings.AUTH_USER_MODEL,related_name="subscription",on_delete=models.CASCADE); plan_code=models.CharField(max_length=30,choices=Plan.choices,default=Plan.FREE); status=models.CharField(max_length=30,choices=Status.choices,default=Status.ACTIVE); provider=models.CharField(max_length=30,default="manual"); provider_customer_id=models.CharField(max_length=120,blank=True); provider_subscription_id=models.CharField(max_length=120,blank=True); current_period_start=models.DateTimeField(blank=True,null=True); current_period_end=models.DateTimeField(blank=True,null=True); cancel_at_period_end=models.BooleanField(default=False); created_at=models.DateTimeField(auto_now_add=True); updated_at=models.DateTimeField(auto_now=True)
