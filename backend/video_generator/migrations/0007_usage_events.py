...
class Migration(migrations.Migration):
    ...
    operations = [migrations.CreateModel(name="UsageEvent", fields=[
        ...
        ("quantity", models.PositiveIntegerField(default=1)), ("credits", models.PositiveIntegerField(default=0)), ("idempotency_key", models.CharField(max_length=160, unique=True)), ("created_at", models.DateTimeField(auto_now_add=True)),
