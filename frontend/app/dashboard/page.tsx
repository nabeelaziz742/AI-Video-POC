...
export default function DashboardPage() {
  ...
  useEffect(() => {
    Promise.all([api<{ user: User }>("/auth/me/"), api<VideoProject[]>("/projects/")])
      .then(([me, data]) => { setUser(me.user); setProjects(data); })
