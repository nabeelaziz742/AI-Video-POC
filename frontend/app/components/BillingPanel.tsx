              ...
              <div>
                ...
                <ul className="mt-4 space-y-2 text-xs text-white/60">
                  <li className="flex items-center gap-2">
                    ...
                    <span><strong>{plan.monthly_credits}</strong> credits (1s = 1 credit)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg className="h-4 w-4 shrink-0 text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Up to <strong>{plan.max_duration}s</strong> duration</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg className="h-4 w-4 shrink-0 text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    ...
                    <span>
                      {plan.code === "free"
                        ? "Auto character extraction"
                        : "Advanced Character Control unlocked"}
                    </span>
                  </li>
                </ul>
              </div>
